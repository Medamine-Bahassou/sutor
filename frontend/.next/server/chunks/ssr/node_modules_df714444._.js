...
"[project]/node_modules/@pkasila/react-katex/lib/src/utils/hasMathMLSupport.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
function hasMathMLSupport() {
    ...
    div.innerHTML = '<math><mfrac><mn>1</mn><mn>2</mn></mfrac></math>' + '<math><mn>1</mn></math>';
    document.body.appendChild(div);
    const res = div.firstElementChild.firstElementChild.getBoundingClientRect().height > div.lastElementChild.firstElementChild.getBoundingClientRect().height + 1;
    document.body.removeChild(div);
    return res;
}
exports.default = hasMathMLSupport;
}}),
"[project]/node_modules/@pkasila/react-katex/lib/src/utils/latexify.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
const katex_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/katex/dist/katex.js [app-ssr] (ecmascript)"));
...
const latexify = (string, options)=>{
    ...
    const renderLatexString = (s, t)=>{
        ...
        try {
            ...
            renderedString = katex_1.default.renderToString(s, opts);
        } catch (err) {
            ...
            if (r.type === 'text') {
                if (options.breakLine) {
                    ...
                    return react_1.default.createElement(react_1.Fragment, {
                        key: `breakLine-${rootIdx}`
                    }, arr.map((s, idx)=>react_1.default.createElement(react_1.Fragment, {
                            key: `breakLine-${rootIdx}-${idx}`
                        }, s, idx !== arr.length - 1 ? react_1.default.createElement("br", null) : null)));
                } else {
                    return react_1.default.createElement(react_1.Fragment, {
                        key: `noBreakLine-${rootIdx}`
                    }, r.string);
                }
            }
...
exports.default = latexify;
}}),
"[project]/node_modules/@pkasila/react-katex/lib/src/utils/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
const hasMathMLSupport_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@pkasila/react-katex/lib/src/utils/hasMathMLSupport.js [app-ssr] (ecmascript)"));
const latexify_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@pkasila/react-katex/lib/src/utils/latexify.js [app-ssr] (ecmascript)"));
exports.default = {
    hasMathMLSupport: hasMathMLSupport_1.default,
    latexify: latexify_1.default
};
}}),
"[project]/node_modules/@pkasila/react-katex/lib/src/index.js [app-ssr] (ecmascript)": (function(__turbopack_context__) {
...
const prop_types_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/prop-types/index.js [app-ssr] (ecmascript)"));
const utils_1 = __importDefault(__turbopack_context__.r("[project]/node_modules/@pkasila/react-katex/lib/src/utils/index.js [app-ssr] (ecmascript)"));
class ReactKatex extends react_1.default.Component {
    constructor(props){
        super(props);
    }
    render() {
        const _a = this.props, { children } = _a, rest = __rest(_a, [
            "children"
        ]);
        // Check MathML support
        if (!rest.enforceOutput && rest.output === 'mathml' && !utils_1.default.hasMathMLSupport()) {
        ...
        const renderUs = utils_1.default.latexify(children, rest);
        return react_1.default.createElement("span", null, renderUs);
    }
}
exports.default = ReactKatex;
ReactKatex.defaultProps = {
    children: null,
    displayMode: false,
...
ReactKatex.propTypes = {
    children: prop_types_1.default.string,
    displayMode: prop_types_1.default.bool,
    leqno: prop_types_1.default.bool,
    fleqn: prop_types_1.default.bool,
    throwOnError: prop_types_1.default.bool,
    errorColor: prop_types_1.default.string,
    macros: prop_types_1.default.object,
    minRuleThickness: prop_types_1.default.number,
    colorIsTextColor: prop_types_1.default.bool,
    maxSize: prop_types_1.default.number,
    maxExpand: prop_types_1.default.number,
    strict: prop_types_1.default.oneOfType([
        prop_types_1.default.bool,
        prop_types_1.default.string,
        prop_types_1.default.func
    ]),
    trust: prop_types_1.default.oneOfType([
        prop_types_1.default.bool,
        prop_types_1.default.func
    ]),
    output: prop_types_1.default.oneOf([
        'html',
        'mathml',
        'htmlAndMathml'
    ]),
    enforceOutput: prop_types_1.default.bool,
...
//# sourceMappingURL=node_modules_df714444._.js.map